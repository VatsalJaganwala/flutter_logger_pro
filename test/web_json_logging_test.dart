...
void main() {
  group('Web JSON Logging Tests', () {
    ...
    test('Web JSON logging shows complete message in IDE logs', () {
      ...
      final testData = {
        'message':
            'This should be visible in both browser console and IDE logs',
        'data': {
          'nested': true,
          'values': [1, 2, 3],
        },
      ...
      expect(
        () => logger.jsonError(testData, label: 'Error Data'),
        returnsNormally,
      );
    });
    ...
    test('Web JSON logging handles complex nested objects', () {
      ...
      expect(
        () => logger.json(complexData, label: 'Complex Data'),
        returnsNormally,
      );
    });
    ...
    test('Web JSON logging with different log levels', () {
      ...
      expect(
        () => logger.jsonWarn(testData, label: 'Warning'),
        returnsNormally,
      );
