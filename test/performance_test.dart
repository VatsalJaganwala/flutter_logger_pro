...
void main() {
  group('Performance Tests', () {
    ...
    test('Logger performance with LoggerOptions enabled vs disabled', () {
      ...
      expect(disabledTime < baselineTime, isTrue, 
      ...
      expect(disabledSpeedup > 0.5, isTrue,
    ...
    test('Logger performance with different log levels', () {
      ...
      expect(errorTime < debugTime, isTrue,
    ...
    test('Logger creation performance with and without LoggerOptions', () {
      ...
      expect(ratio < 2.0, isTrue,
        reason: 'Logger creation with LoggerOptions should not be more than 2x slower than baseline');
    });
    ...
    test('Memory usage with multiple loggers', () {
      ...
      print('Memory Test ($loggerCount loggers created in ${stopwatch.elapsedMilliseconds}ms)');
