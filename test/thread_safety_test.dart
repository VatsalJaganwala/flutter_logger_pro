...
void main() {
  group('Thread Safety Tests', () {
    ...
    test('LoggerOptions singleton is consistent across isolates', () async {
      ...
      expect(
        LoggerOptions.instance.effectiveMinLogLevel,
    ...
    test('Concurrent LoggerOptions configuration is safe', () async {
      ...
      expect(
        () => logger.info('Test after concurrent config'),
        returnsNormally,
      );
    });
    ...
    test('Logger performance under concurrent usage', () async {
      ...
      print(
        'Concurrent Performance: $totalMessages messages in ${stopwatch.elapsedMilliseconds}ms',
      );
